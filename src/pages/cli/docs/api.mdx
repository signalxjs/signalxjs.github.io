...
Arguments are declared with the `a` builders rather than a plain shape object; see [Declaring command arguments](/cli/docs/plugins#declaring-command-arguments) and the [`@sigx/args` guide](/terminal/packages/args/overview/) for the full builder reference.
