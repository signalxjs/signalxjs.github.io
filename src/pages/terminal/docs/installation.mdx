...
- **Node 18 or newer** — for ESM support and the built-in `fetch` the [data-loading](/terminal/docs/getting-started) examples rely on. The Vite build target below is `node18` for the same reason.
