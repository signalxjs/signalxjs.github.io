---
title: Lifecycle
description: "The SignalX component lifecycle — setup runs once, the render function tracks signals, and onMounted / onUnmounted hooks bracket the DOM lifetime."
layout: docs
