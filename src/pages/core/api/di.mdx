...
description: "API reference for SignalX dependency injection — provide, inject, createInjectable and defineInjectable for typed services across the component tree."
layout: docs
category: Reference
order: 50
---
