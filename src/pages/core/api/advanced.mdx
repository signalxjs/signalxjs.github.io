---
title: Advanced
description: "API reference for SignalX advanced utilities — defineFactory, Lifetime, createTopic and createTopicGroup, the lower-level building blocks, with signatures."
layout: docs
category: Reference
order: 80
---
