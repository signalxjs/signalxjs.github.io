---
title: "API reference"
description: "API reference for @sigx/lynx-safe-area — every export of the SignalX Lynx Safe Area module."
layout: module-docs
category: "Reference"
order: 40
---
...
<p class="lede">Exports of `@sigx/lynx-safe-area` <PkgVersion npm="@sigx/lynx-safe-area" />.</p>
