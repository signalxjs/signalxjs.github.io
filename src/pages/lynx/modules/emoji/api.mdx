...
<p class="lede">Every export of `@sigx/lynx-emoji` <PkgVersion npm="@sigx/lynx-emoji" />. The package is pure JS — all exports work identically on iOS and Android, no native module or permissions.</p>
