...
- [**EmojiGrid**](/lynx/modules/emoji/components/emojigrid) — the headless grid: a native `<list>` recycler in flow layout, so only on-screen cells exist regardless of count.
