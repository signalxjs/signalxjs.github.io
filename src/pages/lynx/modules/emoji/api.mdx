...
<p class="lede">Every export of `@sigx/lynx-emoji` v0.5.0. The package is pure JS — all exports work identically on iOS and Android, no native module or permissions.</p>
