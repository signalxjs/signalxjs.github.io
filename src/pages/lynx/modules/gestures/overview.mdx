---
title: "Overview"
description: "Frame-locked touch handling — the Gestures module for SignalX Lynx (@sigx/lynx-gestures): what it does, setup and API."
layout: module-docs
...
<p class="mod-meta-row"><strong>31k</strong> weekly <span class="mmr-dot" /> <PkgVersion npm="@sigx/lynx-gestures" /> <span class="mmr-dot" /> iOS · Android <span class="mmr-dot" /> MIT</p>
