---
title: "API reference"
description: "API reference for @sigx/lynx-markdown — every export of the SignalX Lynx Markdown module."
layout: module-docs
category: "Reference"
order: 40
---
...
<p class="lede">Exports of `@sigx/lynx-markdown` <PkgVersion npm="@sigx/lynx-markdown" />.</p>
