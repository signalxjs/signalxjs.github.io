---
title: "API reference"
description: "API reference for @sigx/lynx-file-system — every export of the SignalX Lynx File System module."
layout: module-docs
category: "Reference"
order: 40
---
...
<p class="lede">Exports of `@sigx/lynx-file-system` <PkgVersion npm="@sigx/lynx-file-system" />.</p>
