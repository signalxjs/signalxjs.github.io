---
title: "API reference"
description: "API reference for @sigx/lynx-file-picker — every export of the SignalX Lynx File Picker module."
layout: module-docs
category: "Reference"
order: 40
---
...
<p class="lede">Every export of `@sigx/lynx-file-picker` <PkgVersion npm="@sigx/lynx-file-picker" />.</p>
