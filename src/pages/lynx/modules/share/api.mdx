---
title: "API reference"
description: "API reference for @sigx/lynx-share — every export of the SignalX Lynx Share module."
layout: module-docs
category: "Reference"
order: 40
---
...
<p class="lede">Exports of `@sigx/lynx-share` <PkgVersion npm="@sigx/lynx-share" />.</p>
