...
The effect is that a heavy destination slides in at vsync cadence instead of stuttering into place. There is **no new API** — this is how animated transitions behave.
