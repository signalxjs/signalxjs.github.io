---
title: "Overview"
description: "Type-first native navigator — the Navigation module for SignalX Lynx (@sigx/lynx-navigation): what it does, setup and API."
layout: module-docs
...
<p class="mod-meta-row"><strong>48k</strong> weekly <span class="mmr-dot" /> <PkgVersion npm="@sigx/lynx-navigation" /> <span class="mmr-dot" /> iOS · Android <span class="mmr-dot" /> MIT</p>
