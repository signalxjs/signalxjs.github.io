---
title: "Map"
description: "Map — @sigx/lynx-maps component"
layout: module-docs
...
<p class="lede">Native map view that renders Apple Maps (`MKMapView`) on iOS and Google Maps on Android, with any number of <a href="/lynx/modules/maps/components/map-marker">MapMarker</a> children as pins. Works on both platforms; Android needs a Google Maps API key.</p>
...
| `children` | `unknown` | The [`MapMarker`](/lynx/modules/maps/components/map-marker) pins. |

### Slots

| Slot | Description |
|------|-------------|
| `default` | Any number of [`MapMarker`](/lynx/modules/maps/components/map-marker) children rendered as pins. |
...
- [`MapMarker`](/lynx/modules/maps/components/map-marker) — the pin children rendered inside a `Map`.
