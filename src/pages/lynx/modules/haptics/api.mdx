---
title: "API reference"
description: "API reference for @sigx/lynx-haptics — every export of the SignalX Lynx Haptics module."
layout: module-docs
category: "Reference"
order: 40
---
...
<p class="lede">Exports of `@sigx/lynx-haptics` <PkgVersion npm="@sigx/lynx-haptics" />.</p>
