...
Cancels a scheduled or delivered notification by id. No-op if the id is not scheduled.
...
Cancels all pending notifications scheduled by this app (on iOS, also delivered ones).
