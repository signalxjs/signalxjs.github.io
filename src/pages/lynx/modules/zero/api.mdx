...
<p class="lede">Every export of `@sigx/lynx-zero` v0.5.0 — the headless contract, shared style/press/tabs helpers, the theme engine, layout primitives and the Tailwind preset.</p>
