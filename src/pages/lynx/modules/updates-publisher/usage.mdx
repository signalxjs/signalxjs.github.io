---
title: "Usage"
description: "Using OTA Publisher in a SignalX Lynx app — cI bundle publisher patterns and examples with @sigx/lynx-updates-publisher."
layout: module-docs
category: "Guides"
order: 30
---
...
`@sigx/lynx-updates-publisher` is the publish step of OTA, factored out of the CLI so a release pipeline can call it directly. It writes the same static-host layout that the `StaticManifestProvider` in [`@sigx/lynx-updates`](/lynx/modules/updates/overview) reads.
