---
title: "API reference"
description: "API reference for @sigx/lynx-runtime-main — every export of the SignalX Lynx Main Runtime module."
layout: module-docs
category: "Reference"
order: 40
---
...
<p class="lede">Public exports of `@sigx/lynx-runtime-main` <PkgVersion npm="@sigx/lynx-runtime-main" />. This is a pure-TypeScript Lepus runtime — every API runs on the Lynx main thread; there is no native iOS or Android module.</p>
