...
<p class="lede">Public exports of `@sigx/lynx-runtime-main` v0.4.9. This is a pure-TypeScript Lepus runtime — every API runs on the Lynx main thread; there is no native iOS or Android module.</p>
