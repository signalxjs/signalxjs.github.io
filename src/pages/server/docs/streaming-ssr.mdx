---
title: Streaming SSR with an HTTP Server
description: "Wire renderToNodeStream/renderToStream into Express, Fastify, or H3, and stream async data with ssr.load()"
layout: docs
category: Guides
order: 30
---
...
This guide wires the render APIs into a real HTTP server and shows how async data
streams to the client. Every example uses inventoried exports only.
