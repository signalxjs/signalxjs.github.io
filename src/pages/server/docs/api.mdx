---
title: API Reference
description: "@sigx/server-renderer — streaming SSR and island hydration — API reference"
layout: docs
...
Return all currently registered client-side `SSRPlugin`s.
...
VNode extended with internal hydration bookkeeping (subtree refs, reactive effect,
props/slots). Exposed for plugin authors.
