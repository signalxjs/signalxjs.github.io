...
warning — a nudge to move validation into the options form's `input` schema once a
function is a real client boundary. Use the direct form for trusted, app-internal
