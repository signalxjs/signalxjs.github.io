---
title: Authoring server functions
...
schema-validated and the argument count is not enforced at runtime. Use the
direct form for trusted, app-internal calls; reach for the options form (below)
when a function is a validated boundary.
...
- [Deployment & security](/server/docs/deployment) — serve the endpoint in dev,
