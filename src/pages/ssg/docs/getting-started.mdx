...
- **Layouts and themes** — wrap pages in shared shells, or pull a full theme from a package (such as [`@sigx/ssg-theme-daisyui`](/ssg/docs/themes)).
...
The current package version is <PkgVersion npm="@sigx/ssg" />.
...
- [Client Runtime](/ssg/docs/client-runtime) — search, the package-manager switcher, copy-code, and SPA navigation.
