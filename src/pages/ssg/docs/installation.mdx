...
- **`sigx@>=0.6.0 <0.7.0`** — the SignalX runtime.
- **`@sigx/router@>=0.6.0 <0.7.0`** — the router the generated client entry drives.
- **`@sigx/server-renderer@>=0.6.0 <0.7.0`** — used for the SSR render and the hydration client plugin.
