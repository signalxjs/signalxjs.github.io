...
[`@sigx/actors-monitor`](/actors/packages/actors-monitor/overview), and
[`@sigx/actors-dashboard`](/actors/packages/actors-dashboard/overview) draws the same layer in
...
- [API reference](/actors/packages/actors-cli/api) — the `/source` subpath and `embeddedSource`.
- [`@sigx/actors-dashboard`](/actors/packages/actors-dashboard/overview) — the web rendering.
